        ...
        {lanes.map(lane => (
          <div key={lane.id} style={styles.lane}>
            <div style={styles.laneHeader}>
              ...
              >
                <div style={styles.taskList}>
                  {tasks.filter(task => task.laneId === lane.id).map(task => (
                    <div
                      key={task._id}
                      style={styles.taskCard}
                      draggable
                    ...
                    >
                      {editingTask === task._id ? (
                        ...
                        <div onDoubleClick={() => handleStartEditing(task)} style={styles.taskTitle}>
                          {task.title}
                        </div>
                      )}
                      <button onClick={() => handleDeleteTask(task._id)} style={styles.deleteButton}>Delete</button>
                    </div>
                  ))}
                </div>
              </div>
